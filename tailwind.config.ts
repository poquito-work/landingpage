...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        'pq-green': '#143322',
        'pq-green-dark': '#0C2318',
        'pq-green-mid': '#1a4230',
        'pq-rust': '#B65A2F',
        'pq-rust-dark': '#943f1e',
        'pq-cream': '#F9F2E4',
        'pq-cream-dark': '#ede5d4',
      },
      fontFamily: {
        hero: ['Hero', 'Georgia', 'serif'],
      },
      keyframes: {
        float: {
      ...
      animation: {
        ...
        'float-delay-2': 'float 5s ease-in-out 2s infinite',
        'float-delay-3': 'float 4.5s ease-in-out 0.5s infinite',
