...
const features = [
  {
    ...
    tile: '/images/tiles/Mpt1m.png',
    tiles: ['/images/tiles/Mpt2m.png', '/images/tiles/Mpt3m.png'],
    tag: 'Solo Play',
  },
  {
    id: 'private',
    ...
    tile: '/images/tiles/Mpt2z.png',
    tiles: ['/images/tiles/Mpt3z.png'],
    tag: 'Social',
  },
  {
    id: 'public',
  ...
  },
  {
    ...
    tile: '/images/tiles/Mpt7z.png',
    tiles: ['/images/tiles/Mpu1z.png', '/images/tiles/Mpu3z.png'],
    tag: 'Competitive',
  ...
  },
  {
    ...
    tile: '/images/tiles/Mpu3z.png',
    tiles: ['/images/tiles/Mpt1m.png', '/images/tiles/Mpt2m.png'],
    tag: 'Intelligence',
  },
]
          ...
          >
            ...
            <div className="relative z-10 p-7 lg:p-9 flex flex-col justify-between h-full">
              ...
              <div className="absolute right-6 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-2 items-center">
                {['/images/tiles/Mpt7z.png','/images/tiles/Mpu1z.png','/images/tiles/Mpu3z.png'].map((src, i) => (
                  <motion.div
                    key={i}
