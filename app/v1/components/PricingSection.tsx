...
const bgTiles = [
  { src: '/images/v1/tiles/Mpt7z.png', left: '2%',  top: '18%', w: 52, rot: -14, op: 0.10, dur: 9,  delay: 0   },
  { src: '/images/v1/tiles/Mpu1z.png', left: '5%',  top: '72%', w: 40, rot: 20,  op: 0.08, dur: 8,  delay: 1.5 },
  { src: '/images/v1/tiles/Mpt2z.png', left: '91%', top: '12%', w: 48, rot: -8,  op: 0.09, dur: 10, delay: 0.5 },
  { src: '/images/v1/tiles/Mpt1m.png', left: '88%', top: '75%', w: 44, rot: 18,  op: 0.10, dur: 7,  delay: 2.0 },
  { src: '/images/v1/tiles/Mpt3z.png', left: '50%', top: '88%', w: 36, rot: -20, op: 0.07, dur: 11, delay: 1.0 },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-5 items-stretch">
          ...
          >
            ...
            <div className="absolute top-6 right-16 hidden lg:flex gap-2 items-start pointer-events-none opacity-[0.22]">
              {[
                { src: '/images/v1/tiles/Mpt7z.png', rot: 18, top: 0 },
                { src: '/images/v1/tiles/Mpu1z.png', rot: -12, top: 20 },
              ].map((t, i) => (
