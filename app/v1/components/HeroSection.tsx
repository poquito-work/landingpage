...
const phoneTiles = [
  { src: '/images/v1/tiles/Mpt1z.png',  x: -72,  y:  90, rot: -18, scale: 0.88, delay: 0,   z: 10 },
  { src: '/images/v1/tiles/Mpt2m.png',  x:  74,  y: -44, rot:  14, scale: 0.72, delay: 0.8, z: 20 },
  { src: '/images/v1/tiles/Mpt3z.png',  x: -90,  y: -64, rot:  -8, scale: 0.66, delay: 1.4, z: 8  },
  { src: '/images/v1/tiles/Mpt3m.png',  x: 108,  y: 126, rot:  22, scale: 0.76, delay: 0.4, z: 20 },
  { src: '/images/v1/tiles/Mpt4m.png',  x: -36,  y: 212, rot: -24, scale: 0.62, delay: 1.8, z: 6  },
  { src: '/images/v1/tiles/Mpu1z.png',  x: 148,  y:  66, rot:  10, scale: 0.56, delay: 2.2, z: 6  },
  { src: '/images/v1/tiles/Mpt7z.png',  x: -116, y:  14, rot:  -6, scale: 0.50, delay: 1.0, z: 5  },
]

/* Ambient background tiles — spread across full section, z-1, very low opacity */
const bgTiles = [
  { src: '/images/v1/tiles/Mpt1z.png',  left: '4%',  top: '14%', w: 54, rot: -12, op: 0.17, dur: 7.5, delay: 0   },
  { src: '/images/v1/tiles/Mpt2m.png',  left: '10%', top: '72%', w: 44, rot: 20,  op: 0.13, dur: 8.5, delay: 1.2 },
  { src: '/images/v1/tiles/Mpt3z.png',  left: '89%', top: '9%',  w: 50, rot: -7,  op: 0.15, dur: 9.0, delay: 0.5 },
  { src: '/images/v1/tiles/Mpt4m.png',  left: '84%', top: '78%', w: 56, rot: 24,  op: 0.16, dur: 6.5, delay: 2.0 },
  { src: '/images/v1/tiles/Mpu1z.png',  left: '53%', top: '4%',  w: 42, rot: -16, op: 0.12, dur: 10,  delay: 0.8 },
  { src: '/images/v1/tiles/Mpt7z.png',  left: '74%', top: '87%', w: 48, rot: 10,  op: 0.14, dur: 7.0, delay: 1.5 },
  { src: '/images/v1/tiles/Mpt3m.png',  left: '32%', top: '91%', w: 38, rot: -22, op: 0.11, dur: 8.0, delay: 2.4 },
  { src: '/images/v1/tiles/Mpu3z.png',  left: '1%',  top: '42%', w: 46, rot: 15,  op: 0.15, dur: 9.5, delay: 0.3 },
  { src: '/images/v1/tiles/Mpt2z.png',  left: '96%', top: '46%', w: 40, rot: -9,  op: 0.13, dur: 7.5, delay: 1.8 },
  { src: '/images/v1/tiles/Mpt1m.png',  left: '62%', top: '92%', w: 36, rot: 28,  op: 0.10, dur: 11,  delay: 3.0 },
]

const phoneHandTiles = [
  '/images/v1/tiles/Mpt1m.png',
  '/images/v1/tiles/Mpt2m.png',
  '/images/v1/tiles/Mpt3m.png',
  '/images/v1/tiles/Mpt1z.png',
  '/images/v1/tiles/Mpt2z.png',
  '/images/v1/tiles/Mpt3z.png',
]
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <StoreButton icon="/images/v1/appstore.png"   label="App Store"   />
                <StoreButton icon="/images/v1/googleplay.png" label="Google Play" />
              </div>
            </motion.div>
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col" style={{ background: 'linear-gradient(160deg, #143322 0%, #0c2318 100%)' }}>
        ...
        <div className="px-5 pt-1 pb-3 flex items-center justify-between border-b border-white/5">
          <Image src="/images/v1/logo.png" alt="Poquito" width={80} height={28} className="brightness-0 invert opacity-70" />
